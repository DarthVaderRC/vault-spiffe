...
run_internal() {
  ...
  compose exec -T demo-tools bash -lc \
    "export PYTHONPATH=/workspace/demo/python KUBECONFIG=/workspace/demo/runtime/kind/kubeconfig-docker ${pause_env}; python /workspace/demo/scripts/internal/k8s_jwt_demo.py '$command'"
}
